...
// This file is responsible for collecting all trips associated with the selected services.
// It reads the trips.txt file and filters trips based on the previously identified service IDs.
package pt
...
func (pto *PTOrchestrator) collectTrips() error {
	pto.logMessage("Starting Trip Collection")
