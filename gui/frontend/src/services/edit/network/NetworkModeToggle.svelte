<script lang="ts">
  import { appState, type NetworkMode } from '../../../store.svelte';
  import EzRadioGroup from '../../../components/EzRadioGroup.svelte';
  import EzRadioOption from '../../../components/EzRadioOption.svelte';
