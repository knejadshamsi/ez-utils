<script lang="ts">
  ...
  import { networkState, getNodeById, getLinkById, canDeleteNode, clearSelection } from './networkStore.svelte';
  import { updateNode, updateLink, deleteNode as deleteNetworkNode, deleteLink as deleteNetworkLink } from './networkApi';
